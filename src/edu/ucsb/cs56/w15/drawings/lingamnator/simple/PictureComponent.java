package edu.ucsb.cs56.w15.drawings.lingamnator.simple;
...
/**
   ...
   @author Krishna Lingampalli (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	Circle snowManTopCircle =
           ...
           (
             snowManCenterBottomX,
             snowManCenterBottomY - bottomRadius * 3 - middleRadius,
             topRadius
           );
       ...
       g2.drawString("Top of snowman added by Krishna Lingampalli", 20,40);
    }
